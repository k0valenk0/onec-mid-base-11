...
// Добавляет команды создания документов на основании заказа покупателя для связанных типов документов.
//
// Параметры:
//   КомандыСозданияНаОсновании - ТаблицаЗначений - коллекция команд для заполнения на основании
//   Параметры - Структура - дополнительные параметры для формирования команд
...
// Настраивает параметры печати для документа ЗаказПокупателя, включая возможность добавления команд печати.
//
// Параметры:
//   НастройкиОбъекта - Структура - настройки объекта для формирования печатных форм
//
Процедура ПриОпределенииНастроекПечати(НастройкиОбъекта) Экспорт	
	НастройкиОбъекта.ПриДобавленииКомандПечати = Истина;
КонецПроцедуры

// Формирует список доступных команд печати для документа.
//
// Параметры:
//   КомандыПечати - ТаблицаЗначений - Список команд печати для заполнения
//
...
// Формирует печатные формы для указанных объектов документа (заказ, счет, гарантийное письмо).
//
// Параметры:
//   МассивОбъектов - Массив - Ссылки на объекты документов, для которых требуется печать.
//   ПараметрыПечати - Структура - Дополнительные параметры управления печатью.
//   КоллекцияПечатныхФорм - ТаблицаЗначений - Коллекция для добавляемых печатных форм.
//   ОбъектыПечати - Соответствие - Соответствие имен печатных форм и их объектов.
//   ПараметрыВывода - Структура - Параметры вывода на печать.
//
